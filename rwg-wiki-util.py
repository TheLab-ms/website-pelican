...
my_content_dir = "../website-wiki"
my_prod_config = "wikiconf.py"
my_theme =       "themes/thelab-wiki"
my_output =       "output"
...
# Issue a warning
print "*****************************************************************"
print "*** This script was written to generate and deploy the WIKI.  ***"
print "*****************************************************************"
...
print "*** Content directory is ../website-wiki relative to script      "
print "***   Should contain the Master branch of website-wiki repo      "
print "*** Output directory is ./output relative to script              "
print "***   Output is placed in ./output/wiki directory relative       "
print "*** The Prod configuration file is wikiconfig.py                 "
