...
my_content_dir = "../website-content"
my_prod_config = "pelicanconf.py"
my_theme =       "themes/pelican-bootstrap3-thelab"
my_output =       "output"
...
# Issue a warning
print "*****************************************************************"
print "*** This script was written to generate and deploy the site.  ***"
print "*****************************************************************"
...
print "*** Content directory is ../website-content relative to script   "
print "***   Should contain the Master branch of website-content repo   "
print "*** Output directory is ./output relative to script              "
print "*** The Prod configuration file is pelicanconf.py                "
...
if option.upper() == "G":
  # Generate output using Prod config file
  print "*** Generate output using Prod config file ***\n"
...
if option.upper() == "P":
  ...
  print "*** Generate output using Prod config file ***\n"
  subprocess.call(["pelican", my_content_dir, "-s", my_prod_config, "-t", my_theme])
  # Publish Prod site to AWS S3 bucket
  print "*** Publish Prod site to AWS S3 bucket ***\n"
